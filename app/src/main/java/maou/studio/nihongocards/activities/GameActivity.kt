...
class GameActivity : AppCompatActivity() {
    ...
    private fun getShuffledAlphabet(): List<String>{
        val hiragana = if (HiraganaAlphabet.isPlaying()) HiraganaAlphabet.getShuffledAlphabet() else emptyList()
        val katakana = if (KatakanaAlphabet.isPlaying()) KatakanaAlphabet.getShuffledAlphabet() else emptyList()
